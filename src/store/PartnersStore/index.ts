...
class PartnersStore {
  ...
  getTotalLeadCount(): ILeadCount {
    return this.partners?.reduce(
      (total, partner) => {
        total.newPartner =
          parseInt(total.newPartner) + parseInt(partner.leadCount.newPartner);
        total.inWorkPartner =
          parseInt(total.inWorkPartner) +
          parseInt(partner.leadCount.inWorkPartner);
        total.dealPartner =
          parseInt(total.dealPartner) + parseInt(partner.leadCount.dealPartner);
        total.canceledPartner =
          parseInt(total.canceledPartner) +
          parseInt(partner.leadCount.canceledPartner);
        return total;
      },
      {
        newPartner: "0",
  ...
  getTotalReward(): number | string | null | undefined {
    return this.partners?.reduce(
      (total, partner) =>
  ...
  getTotalBalance(): number | string | null | undefined {
    return this.partners?.reduce(
